...
root and the sample directories its configuration lists, renders through the route its `--route`
flag selects, the envelope morph by default and the fitted models loaded for the latent route alone,
