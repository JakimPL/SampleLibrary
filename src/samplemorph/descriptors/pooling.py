...
from samplemorph.geometry import SEMITONES_PER_OCTAVE, Geometry
from samplemorph.images import Conditioners

DESCRIPTOR_BANDS_PER_SEMITONE: Final[int] = 1


def pooled_band_count(geometry: Geometry, *, bands_per_semitone: int) -> int:
