...
from sampledescriptor.training.refusals import TrainingRefused
...
from sampledescriptor.training.splits import DEFAULT_VALIDATION_SHARE

if TYPE_CHECKING:
    from sampledescriptor.training.run.execution import TrainingOutcome
