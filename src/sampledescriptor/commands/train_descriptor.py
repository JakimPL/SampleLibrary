...
from sampledescriptor.commands.run_arguments import add_run_arguments, run_settings_from, train_and_report
from sampledescriptor.descriptors.shape import DEFAULT_WIDTH
from sampledescriptor.model_paths import DEFAULT_DESCRIPTOR_NAME
...
def run(connection: Connection, config: LibraryConfig, arguments: argparse.Namespace) -> None:
    ...
    from sampledescriptor.training.descriptor.data import load_descriptor_corpus
    from sampledescriptor.training.descriptor.run import run_descriptor_training
    from sampledescriptor.training.run.execution import RunPlacement, TrainingOutcome, check_resume_point
