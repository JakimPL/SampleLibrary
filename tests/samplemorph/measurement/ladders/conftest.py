...
TONE: Final[ResonantTone] = ResonantTone(fundamental_hz=220.0, resonance_hz=1500.0)
...
def tone_mono() -> PreparedMono:
    return prepare_mono(resonant_tone(TONE, rate_hz=float(GEOMETRY.analysis_rate_hz)))
