...
from sampledescriptor.training.metrics import DESCRIPTOR_VALIDATION_LOSS
...
def test_the_trainer_reports_what_it_measures_to_the_run(
    tiny_module: TinyModule, tiny_loader: DataLoader[TinyBatch]
) -> None:
    ...
    assert DESCRIPTOR_VALIDATION_LOSS in run.metrics
