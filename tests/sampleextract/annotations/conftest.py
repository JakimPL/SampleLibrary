...
@pytest.fixture
def stored_annotation(connection: Connection, cataloged_sample: str) -> SampleAnnotation:
    """An annotation carrying all three decisions, so a transfer moving only some of them shows."""
