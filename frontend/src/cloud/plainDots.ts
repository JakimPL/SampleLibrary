...
/** The node layer's style when it stands in for the scatterplot: every point a filled dot the size the theme draws its points, the substrate as faint. */
